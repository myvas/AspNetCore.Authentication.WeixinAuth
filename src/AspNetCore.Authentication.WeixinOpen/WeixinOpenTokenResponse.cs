...
{
    public class WeixinOpenTokenResponse //: OAuthTokenResponse
    {
        /// <summary>
        /// weixin-oauth
        /// </summary>
        ...
        public WeixinOpenTokenResponse() { }

        private WeixinOpenTokenResponse(JObject response)
        {
            Response = response;
        ...
        private WeixinOpenTokenResponse(Exception error)
        {
            Error = error;
        }

        public static WeixinOpenTokenResponse Success(JObject response)
        {
            return new WeixinOpenTokenResponse(response);
        }

        public static WeixinOpenTokenResponse Failed(Exception error)
        {
            return new WeixinOpenTokenResponse(error);
        }
    }
}
