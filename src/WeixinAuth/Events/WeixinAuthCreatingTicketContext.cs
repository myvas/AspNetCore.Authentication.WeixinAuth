...
namespace AspNetCore.Authentication.WeixinAuth.Events
{
    ...
    /// </summary>
    public class WeixinAuthCreatingTicketContext<TOptions> : BaseWeixinAuthContext<TOptions>
        where TOptions : WeixinAuthOptions, new()
    {
        ...
        public WeixinAuthCreatingTicketContext(
            HttpContext context,
            AuthenticationScheme scheme,
            TOptions options,
            HttpClient backchannel,
            AuthenticationTicket ticket,
            WeixinAuthTokenResponse tokens)
        ...
        /// </summary>
        public WeixinAuthTokenResponse TokenResponse { get; }
