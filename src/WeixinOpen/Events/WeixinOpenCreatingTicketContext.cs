...
namespace AspNetCore.Authentication.WeixinOpen.Events
{
    ...
    /// </summary>
    public class WeixinOpenCreatingTicketContext<TOptions> : BaseWeixinOpenContext<TOptions>
        where TOptions : WeixinOpenOptions, new()
    {
        ...
        public WeixinOpenCreatingTicketContext(
            HttpContext context,
            AuthenticationScheme scheme,
            TOptions options,
            HttpClient backchannel,
            AuthenticationTicket ticket,
            WeixinOpenTokenResponse tokens)
        ...
        /// </summary>
        public WeixinOpenTokenResponse TokenResponse { get; }
